...
CREATE TABLE SNIPPETS (
  ...
  FOREIGN KEY (DOCUMENT_NAME, DOCUMENT_VERSION) REFERENCES DOCUMENTS(NAME, VERSION)
);
...
CREATE TABLE DOCUMENT_DEPENDENCIES (
  ...
  FOREIGN KEY (DOCUMENT_NAME, DOCUMENT_VERSION) REFERENCES DOCUMENTS(NAME, VERSION),
    FOREIGN KEY (DEPENDENCY_NAME, DEPENDENCY_VERSION)  REFERENCES DOCUMENTS(NAME, VERSION)
);