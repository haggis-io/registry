...
type GetDocumentsRequest struct {
	...
	Status  Status `protobuf:"varint,4,opt,name=status,enum=api.Status" json:"status,omitempty"`
...
func (m *GetDocumentsRequest) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func init() {
	proto.RegisterType((*GetDocumentsRequest)(nil), "api.GetDocumentsRequest")
	proto.RegisterType((*GetDocumentsResponse)(nil), "api.GetDocumentsResponse")
	...
	proto.RegisterType((*CreateDocumentRequest)(nil), "api.CreateDocumentRequest")
	proto.RegisterType((*CreateDocumentResponse)(nil), "api.CreateDocumentResponse")
	proto.RegisterType((*ApprovedDocumentRequest)(nil), "api.ApprovedDocumentRequest")
	proto.RegisterType((*ApprovedDocumentResponse)(nil), "api.ApprovedDocumentResponse")
	proto.RegisterType((*DeclinedDocumentRequest)(nil), "api.DeclinedDocumentRequest")
	proto.RegisterType((*DeclinedDocumentResponse)(nil), "api.DeclinedDocumentResponse")
	proto.RegisterType((*PendingDocumentRequest)(nil), "api.PendingDocumentRequest")
	proto.RegisterType((*PendingDocumentResponse)(nil), "api.PendingDocumentResponse")
}
...
func (c *registryClient) GetDocuments(ctx context.Context, in *GetDocumentsRequest, opts ...grpc.CallOption) (*GetDocumentsResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.Registry/GetDocuments", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) GetDocument(ctx context.Context, in *GetDocumentRequest, opts ...grpc.CallOption) (*GetDocumentResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.Registry/GetDocument", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) CreateDocument(ctx context.Context, in *CreateDocumentRequest, opts ...grpc.CallOption) (*GetDocumentResponse, error) {
	out := new(GetDocumentResponse)
	err := grpc.Invoke(ctx, "/api.Registry/CreateDocument", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) MarkAsApproved(ctx context.Context, in *ApprovedDocumentRequest, opts ...grpc.CallOption) (*ApprovedDocumentResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.Registry/MarkAsApproved", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) MarkAsDeclined(ctx context.Context, in *DeclinedDocumentRequest, opts ...grpc.CallOption) (*DeclinedDocumentResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.Registry/MarkAsDeclined", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) MarkAsPending(ctx context.Context, in *PendingDocumentRequest, opts ...grpc.CallOption) (*PendingDocumentResponse, error) {
	...
	err := grpc.Invoke(ctx, "/api.Registry/MarkAsPending", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Registry_GetDocuments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Registry/GetDocuments",
	}
...
func _Registry_GetDocument_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Registry/GetDocument",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Registry_CreateDocument_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Registry/CreateDocument",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Registry_MarkAsApproved_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Registry/MarkAsApproved",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Registry_MarkAsDeclined_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Registry/MarkAsDeclined",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Registry_MarkAsPending_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Registry/MarkAsPending",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var fileDescriptor1 = []byte{
	...
	,
}
